...
public class SAMLUtils {
  ...
  public static void signAssertion(Assertion assertion, Crypto crypto,
    ...
    try {
      ...
      LOGGER.debug("Unable to get issuer private key for issuer alias " + issuerKeyAlias);
    ...
    try {
      ...
      LOGGER.debug("Error while marshalling assertion ", e);
    ...
    try {
      ...
      LOGGER.debug("Error signing SAML Assertion. An error occurred while signing SAML Assertion with alias "
                   + issuerKeyAlias, e);
   ...
   * @throws TrustException If unable to find the builder.
   */
  ...
  /**
   * Creates opensaml SubjectConfirmation representation. The relevant XML would look as follows,
  ...
  /**
   * Creates an opensaml Subject representation. The relevant XML would look as follows,
   * <pre>   &lt;saml:Subject&gt;
   *       &lt;saml:NameIdentifier
   ...
   * @throws TrustException If unable to find the appropriate builder.
   */
   ...
   * @throws TrustException If unable to find appropriate builder.
   */
  ...
  /**
   * This method creates the final SAML assertion. The final SAML assertion would look like as follows,
  ...
  /**
   * Creates a KeyInfo element given EncryptedKey. The relevant XML would look as follows,
