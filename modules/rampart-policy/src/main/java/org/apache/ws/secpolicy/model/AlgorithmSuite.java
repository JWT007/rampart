...
public class AlgorithmSuite extends AbstractConfigurableSecurityAssertion {
  ...
  private static final String ASYMMETRIC_SIGNATURE = SPConstants.RSA_SHA1;

  private static final String COMPUTED_KEY = SPConstants.P_SHA1;

  private static final int MINIMUM_ASYMMETRIC_KEY_LENGTH = 1024;

  private static final int MAXIMUM_ASYMMETRIC_KEY_LENGTH = 4096;
  ...
  public String getAsymmetricSignature() {
    if(Objects.equals(this.digest, SPConstants.SHA256)) {
      return SPConstants.RSA_SHA256;
    } else if(Objects.equals(this.digest, SPConstants.SHA512)) {
  ...
  public int getMaximumAsymmetricKeyLength() {
    return MAXIMUM_ASYMMETRIC_KEY_LENGTH;
  }
  ...
  public int getMinimumAsymmetricKeyLength() {
    return MINIMUM_ASYMMETRIC_KEY_LENGTH;
  }
