...
public class WSS10Builder implements AssertionBuilder<OMElement> {
  ...
  public Assertion build(OMElement element, AssertionBuilderFactory factory) throws IllegalArgumentException {
    ...
    final Wss10 wss10 = new Wss10(SPConstants.SP_V12);
    ...
    if (alternatives.hasNext()) { // there should be max one alternative
      processAlternative(alternatives.next(), wss10);
    }
  ...
  private void processAlternative(final List<Assertion> assertions, final Wss10 parent) {
